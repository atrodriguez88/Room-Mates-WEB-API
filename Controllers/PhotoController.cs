...
namespace RoomM.API.Controllers
{
    ...
    public class PhotoController : ControllerBase
    {
        ...
        public PhotoController(IHostingEnvironment host, IRoomService roomService, IProfileService profileService,
                                IUnitOfWork uow, IMapper mapper, IPhotoService photoService)
        {
            this.host = host;            
